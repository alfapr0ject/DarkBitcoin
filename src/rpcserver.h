...
extern json_spirit::Value importwalletdump(const json_spirit::Array& params, bool fHelp);
...
extern json_spirit::Value validateoutputs(const json_spirit::Array& params, bool fHelp);
